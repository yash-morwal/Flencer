...
const CreativeGraphic = () => {
  return (
    <div className="relative w-full h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px]">
      ...
      {/* Single Empty Card */}
      <div className="absolute top-1/2 left-1/2 w-64 h-48 bg-[#87e64b]/50 backdrop-blur-lg border border-gray-700 rounded-2xl shadow-lg shadow-white/20 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center text-white text-lg">
        {/* Empty Card */}
      </div>
